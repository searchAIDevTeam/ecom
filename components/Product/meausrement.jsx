...
const meausrement = () => {
  ...
  return (
    <div className="flex sm:flex-row w-full flex-col sm:px-[50px] px-[20px] relative">
  <div className="relative">
    <Image src="/product/curtain.avif" alt="curtain" width={700} height={500} className="mb-20" />
        ...
        >
          <div className="flex flex-row relative">
            ...
            <div className="absolute right-0 top-0 border-l border-black flex justify-end items-center h-full pr-1">
              <Image className="flex ml-2 mr-2"
